...
\begin{center}
\frame{\includegraphics[scale=0.2]{mull-thesis.png}}
\end{center}
\end{column}

\begin{column}{0.3\textwidth}
\begin{center}
\includegraphics[scale=0.2]{mull.jpeg}
\end{center}
\end{column}
...
\begin{frame}{سیستم \lr{Nathan Mull}}
...
\lambda_S \in \mathrm{WN} &\implies (\lambda_{S^*} \in \mathrm{SN} \iff \lambda_S \in \mathrm{SN}) &\text{لم}\\
\lambda_S \in \mathrm{WN} &\implies \lambda_S \in \mathrm{SN} &\text{نتیجه}
\end{align*}
...
\begin{column}{0.5\textwidth}
\begin{center}
\frame{\includegraphics[scale=0.17]{done.png}}
\end{center}
\end{column}
